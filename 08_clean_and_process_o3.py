...
df = pd.read_csv(
    r"C:\Users\Mariam Saad\Desktop\hUMAN hEALTH\python\o3_2026.csv"
)
...
weights = pd.read_csv(
    r"C:\Users\Mariam Saad\Desktop\hUMAN hEALTH\python\o3_weights.csv"
)
...
weekly_o3 = weekly_o3.rename(
    columns={"idsensore": "idSensore"}
)

merged = weekly_o3.merge(
    weights,
    on="idSensore",
    how="left"
)
...
print(ats_weekly_o3.head())

print(ats_weekly_o3.shape)

ats_weekly_o3.to_csv(
    r"C:\Users\Mariam Saad\Desktop\hUMAN hEALTH\python\processed_data\ats_weekly_o3_2026.csv",
    index=False
)

print("2026 O3 dataset saved")